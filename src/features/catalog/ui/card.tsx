    ...
    return (
        <Card className="p-0 pb-[1.313rem] lg:pb-[1.813rem] rounded-[0.938rem] lg:rounded-[1.375rem]">
            <CardHeader className="p-0">
                <div className="aspect-[3/2] lg:aspect-[4/3] overflow-hidden bg-cover bg-center rounded-t-[0.563rem] lg:rounded-t-[1.25rem] p-[0.875rem]" style={{ backgroundImage: `url(${imageUrl})` }}>
                    ...
                    <div className="flex flex-col gap-[0.375rem]">
                        ...
                        <div className="flex flex-wrap gap-[0.375rem]">
                            {times.map((time, index) => (
                                <div key={index} className="bg-[#F3F4F6] rounded-[0.25rem] px-[0.625rem] py-[0.313rem]">
                                    {time}
                                </div>
                            ))}
                        </div>
